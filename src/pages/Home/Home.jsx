            ...
            <div className="container grid grid-cols-2 gap-4">
                ...
                <div>
                    <div className="mt-5 ml-10">
                        <img alt="image" src="https://firebasestorage.googleapis.com/v0/b/supporttickets-cb452.appspot.com/o/ecocalor%2Fmiraflores.jpg?alt=media&token=8124b70d-87cd-44de-ace9-851fa1a7fea1"></img>
                    </div>
                </div>
                ...
                <div className="text-center">
                    <div className="mt-5 ml-10">
                        <img alt="image" src='https://firebasestorage.googleapis.com/v0/b/supporttickets-cb452.appspot.com/o/ecocalor%2Fse%C3%B1ora.jpg?alt=media&token=75329952-13ec-4aaf-ad28-5cf896b604a3' />
                    </div>
                </div>
